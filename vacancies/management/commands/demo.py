...
class Command(BaseCommand):
    ...
    jobs = [
        ...
        {"id": "4", "title": "Мидл программист на Python", "specialty": "backend", "company": "7",
         "salary_from": "80000",
    ...
    def handle(self, *args, **options):
        ...
        # airport = Airport.objects.filter(code='DUS')
        # airport = Airport.objects.filter(length__gte=9000)
        # try:
        #     airport = Airport.objects.get(code='DUS').first()
        # except Airport.DoesNotExist:
        #     print('=(')
        # print(airport)
        #
        # with open('airports.json') as fl:
        #     airports_data = json.load(fl)
        # print(airports_data)
        #
        ...
        '''
        for specialty_data in self.specialties:
        ...
        for job_data in self.jobs:
            vacancy = Vacancy.objects.create(
                ...
                specialty=Specialty.objects.get(code=job_data['specialty']),  # job_data['specialty'] Specialty.objects.get(code=...)
                company=Company.objects.get(id=job_data['company']),  # job_data['company']
                salary_min=job_data['salary_from'],
                salary_max=job_data['salary_to'],
                published_at=job_data['posted'],
